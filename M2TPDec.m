...
%genotypes in a decreasing density-dependent manner.
%% Initiation
...
for x = 1:numel(xi)
gen{x}= randsrc(1,xi(x),[1,2,3,4;0.01,0.33,0.33,0.33]);
end
...
Total= sum([gen11Popul,gen10Popul,gen01Popul,gen00Popul]);
    ...
    Gen11Popul{nt}= gen11Popul;
    Gen10Popul{nt}= gen10Popul;
    Gen01Popul{nt}= gen01Popul;
    Gen00Popul{nt}= gen00Popul;
...
save(filename,'Gen11freq','Gen10freq','Gen01freq','Gen00freq','Gen11Popul','Gen10Popul','Gen01Popul','Gen00Popul');
clear;
lambdavector=[7 8 9 10 50];  
clc;
end
